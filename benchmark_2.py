...
# Estimate cost per 1K tokens --> TODO: API usage details would be needed for accurate calculation
PRICES = {
    "qwen3-vl": 0.001,
    "gpt-4o": 0.005,        # ~$2.50/1M input + $10/1M output averaged
    "gpt-4o-mini": 0.0003,  # ~$0.15/1M input + $0.60/1M output averaged
    "gpt-4-turbo": 0.02,
}
...
if __name__ == "__main__":
    ...
    #run_benchmark(
    #    directory="output_frames/P01_01_t104.0s_n30_i7_20251124_112114",  # Your frames directory
    #    model="gpt-4o-mini",  # OpenAI model to use
    #    prompt="What is the next Action of the person in the images?",
    #    num_images_list=[5, 10],  # Test with different image counts
    #    label="pick up cucumber",  # TODO: set your actual expected action
    #    output_csv="benchmark_results.csv"
    #)
